...
module.exports = {
  sentWhatsappOtp: async (receiverNumber, otp) => {
    try {
      const message = await client.messages.create({
        body: `Your login OTP is: ${otp}`,
        from: "whatsapp:+12532929587",
  ...
  getImageUrl: async (files) => {
    ...
    // console.log("util1119999999",params)
    // console.log("🚀 ~ getImageUrl: ~ params:", params)
  ...
  //   }
  // },
  pushNotification: (deviceToken, subject, body, notificationType, callback) => {
    console.log();
    var serverKey = "AAAA2szayCE:APA91bETGkCv3mMw8f8qNFyiCQc4cSFpPwu3HzqocdWvEdosUHAnGB0jhL-PuUsh2aiYUudbjT23qPrXkaR5G-wa35SmJtqVxcAseOicDy4l6YoOFPA8IFy3DUNcVNyFSLUSzNhAyC8i";
